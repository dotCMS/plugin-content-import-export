...
<div style="padding:10px;">
	<div class="shadowBox headerBox" style="width:600px;margin:auto;padding:10px 20px;margin-bottom:20px;">
		...
		<%if(processResults != null){%>
			<div style="padding:5px;"><img src="/html/images/icons/tick.png" hspace="7">
		...
		<%}else{ %>
			<div style="padding:5px;">
				<img src="/html/images/icons/cross-circle.png" hspace="7" align="absbottom">
...
<div style="text-align:center">
	<button dojoType="dijit.form.Button" id="importAgainButton"  onclick="window.location='<portlet:actionURL>
		<portlet:param name="struts_action" value="/ext/content_importer/import_external_contentlets" />
